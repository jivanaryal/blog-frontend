  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800">Discover Blog Posts</h1>
        {token && (
          <Link 
            to="/create-blog" 
      ...
      {blogs.length === 0 ? (
        <div className="text-center py-10">
            ...
            <h3 className="mt-2 text-xl font-medium text-gray-900">No blogs yet</h3>
            <p className="mt-1 text-sm text-gray-500">Get started by creating a new blog post.</p>
            {!token && <p className="mt-2 text-sm text-gray-500">Or <Link to="/login" className="text-teal-600 hover:underline">login</Link> to create one!</p>}
        </div>
      ) : (
            ...
            >
              ...
              <div className="p-5 flex flex-col flex-grow">
                ...
                <div className="text-xs text-gray-500 mb-3 space-x-2">
                  <span>By: <span className="font-medium text-teal-700">{blog.author?.name || "Unknown Author"}</span></span>
                  <span>•</span>
